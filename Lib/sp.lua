do
    ...
    local ThunderImageUI = Instance.new("ImageLabel")
            ...
            ThunderImageUI.Image = "http://www.roblox.com/asset/?id=125132114792447"
    ...
    Title.Text = "Cooking Hub ".."<font color='rgb(178, 102, 255)'>Blox Fruits V2 </font>".."- "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
    Title.RichText = true;
    ...
    Textbtn2.MouseButton1Click:Connect(function()
      ...
      setclipboard("https://www.youtube.com/@binbinvogaming")
      end)
