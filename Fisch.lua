local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/BinbinvoGamingVNClone/BackupScriptRoblox/refs/heads/main/Fluent/Fluent.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/BinbinvoGamingVNClone/BackupScriptRoblox/refs/heads/main/Fluent/Addons/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/BinbinvoGamingVNClone/BackupScriptRoblox/refs/heads/main/Fluent/Addons/InterfaceManager.lua"))()
local Window = Fluent:CreateWindow({
	Title = "Cooking Hub - Fisch",
...
Fluent:Notify({
    Title = "Cooking Hub",
    Content = "Cảm Ơn Vì Đã Sử Dụng!!!",
    Duration = 3
})

Fluent:Notify({
    Title = "Cooking Hub",
    Content = "Credit:BinbinvoGaming",
    Duration = 3
})
...
function Notify(Des, Time, title)
	Fluent:Notify({
		Title= title or "Cooking Hub Notify",
		Content = Des,
		Duration = Time or 3
	})
end

_G['BinbinvoGaming Hub Table'] = {
...
_G['BinbinvoGaming Hub Table'].SizeUi = (not _G['BinbinvoGaming Hub Table'].isWindows and UDim2.fromOffset(600,300)) or UDim2.fromOffset(560,600)
if not _G['BinbinvoGaming Hub Table'].isWindows then
...
ImageButton.MouseButton1Click:Connect(function()
    ...
    if isOpen then
        ImageButton.Image = "" -- Replace with close image asset ID
    else
        ImageButton.Image = "" -- Open image asset ID
    end
...
do -- Config Function
	save = function()
		if not isfolder('Cooking Hub') then
			makefolder('Cooking Hub')
		end
				...
				["embeds"] = {
					{
						...
						["footer"]= {
							["text"]  = "BinbinvoGaming Hub Notify",
							["icon_url"] = "https://cdn.discordapp.com/attachments/1310801717897596928/1310802340663656580/imresizer-1730636227420.jpg?ex=67468b4f&is=674539cf&hm=2709d8c3aede9e0cc7a688ec7092794ad640c2d84d8d506e9a96c0363441657d&"
						}
					}
				}
			})
...
WebHookConfigs = Tap.Configs:AddSection('WebHook') do
	TextBox(WebHookConfigs, "WebHook","","Your Webhook", false, "WebHook Configs")
	TextBox(WebHookConfigs, "Discord Id","","Your Discord ID", false, "Discord Id Ping")
...
do
	...
	InterfaceManager:SetFolder("BinbinvoGaming Hub")
